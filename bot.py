...
# 30 tokens em Polygon (137) — estáveis + blue chips + DeFi + outros
...
async def scanner_loop(app, chat_id: int):
    while True:
        ...
        try:
            ...
            # Sempre envia um snapshot dos top spreads (até 10)
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    STATE[chat] = {
        ...
        "network": network_env,           # usa a REDE do Railway a cada /start
